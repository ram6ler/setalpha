// Generated by dart2js, the Dart to JavaScript compiler version: 1.25.0-dev.13.0.
...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 4],
    ...
    _ChildrenElementList: {
      ...
      addAll$1: function(_, iterable) {
        var t1, _i;
        for (t1 = this._html$_element, _i = 0; _i < 3; ++_i)
          t1.appendChild(iterable[_i]);
      },
      $asEfficientLengthIterable: function() {
        return [W.Element];
      },
    ...
    setAlpha_closure: {
      "^": "Closure:2;",
      call$1: function(x) {
        var hex = J.toRadixString$1$n(H.Primitives_parseInt(x, null, null), 16);
        if (hex.length === 1)
          return "0" + hex;
        else
          return hex;
  ...
  }], ["", "setalpha_example.dart",, F, {
    "^": "",
    main: [function() {
      var t1, t2, e, t3, t4, t5, t6, t7;
      t1 = {};
      t2 = document;
      ...
      e.height = 500;
      t1.moreBubbles = true;
      t3 = new F.main_addBubbles(t1, C.C__JSRandom, 500, 500, e);
      t4 = t2.body;
      t5 = t4.children;
      t6 = t2.createElement("button");
      t6.textContent = "Clear!";
      t7 = W.MouseEvent;
      W._EventStreamSubscription$(t6, "click", new F.main_closure(500, 500, e), false, t7);
      t2 = t2.createElement("button");
      t2.textContent = "Stop!";
      W._EventStreamSubscription$(t2, "click", new F.main_closure0(t1, t3), false, t7);
      new W._ChildrenElementList(t4, t5).addAll$1(0, [e, t6, t2]);
    ...
    main_addBubbles: {
      ...
      call$1: function(_) {
        ...
        t2 = this.rand;
        t3 = C.Map_FCmdn.get$keys();
        t3 = t2.nextInt$1(P.List_List$from(t3, true, H.getRuntimeTypeArgument(t3, "Iterable", 0)).length);
        if (t3 < 0 || t3 >= t1.length)
          return H.ioore(t1, t3);
        stroke = t1[t3];
        fill = T.setAlpha(stroke, 0.3);
        t3 = this.width;
        x = t2.nextInt$1(t3);
        y = t2.nextInt$1(this.height);
        t3 = t2.nextInt$1(t3 / 10 | 0);
        t1 = this.canvas.getContext("2d");
        t1.strokeStyle = stroke;
        t1.save();
        t1.translate(x, y);
        t1.beginPath();
        t1.arc(0, 0, t3 + 10, 0, 6.283185307179586, false);
        t1.fillStyle = fill;
        t1.fill("nonzero");
        t1.stroke();
        t1.rotate(t2.nextDouble$0() * 2 * 3.141592653589793);
        t1.fillStyle = stroke;
        t1.font = "10pt Arial";
        t1.textAlign = "center";
        t1.textBaseline = "middle";
        t1.fillText(stroke, 0, 0);
        t1.restore();
        if (this._box_0.moreBubbles)
          C.Window_methods.get$animationFrame(window).then$1(this);
      }
    },
    main_closure: {
      "^": "Closure:2;width,height,canvas",
      call$1: function(_) {
        var t1 = this.canvas.getContext("2d");
        t1.fillStyle = "white";
        t1.fillRect(0, 0, this.width, this.height);
      }
    },
    main_closure0: {
      "^": "Closure:2;_box_0,addBubbles",
      call$1: function(me) {
        var button, t1;
        button = H.interceptedTypeCast(J.get$target$x(me), "$isButtonElement");
        t1 = this._box_0;
        if (t1.moreBubbles) {
          button.textContent = "Continue!";
          t1.moreBubbles = false;
        } else {
          button.textContent = "Stop!";
          t1.moreBubbles = true;
          C.Window_methods.get$animationFrame(window).then$1(this.addBubbles);
        }
      }
    }
  }, 1]];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(F.setalpha_example__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(F.setalpha_example__main$closure(), a);
